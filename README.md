...
**⚠️ 风险 ⚠️**：该技能提供高风险的医疗诊断、治疗、急诊和侵入性操作指导，这些指导可能被误用为独立的临床建议。

缓解措施：仅将产出作为教育或临床医生审核的参考资料使用，并在诊断、治疗、急诊分诊或操作前，要求合格的临床监督、现行官方指南、本地规范及专家审查。

**⚠️ 风险 ⚠️**：医学影像提示或示例可能涉及患者信息或图像元数据。

缓解措施：除非组织允许且数据已正确去标识化，否则避免输入可识别的患者信息或图像元数据。
